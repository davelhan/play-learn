...
m=mission('07.02');
const batteryGuard=hasCondition(m,'massBudget')&&hasCondition(m,'complexityBudget')&&includesAll(m.goal,['massBudget','complexityBudget'])&&includesAll(m.transferGoal,['massBudget','complexityBudget','max(soc-.15']);
ok('07.02','battery sizing has mass/complexity budgets and low-SoC reserve',batteryGuard);
